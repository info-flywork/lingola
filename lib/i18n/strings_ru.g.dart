...
class _Translations$setup$ru implements Translations$setup$en {
	...
	@override String get levelBeginner => 'Начальный — я знаю несколько слов';
	@override String get levelIntermediate => 'Средний — я могу поддерживать простые разговоры';
	@override String get levelAdvanced => 'Продвинутый — я говорю, но хочу улучшить';
	@override String get paceTitle => 'Как быстро вы хотите улучшаться?';
	@override String get paceLight => '5-10 мин/день (легкий)';
	@override String get paceRecommended => '15-20 мин/день (рекомендуется)';
	@override String get paceFast => '30+ мин/день (быстрые результаты)';
}
...
class _Translations$previewChat$ru implements Translations$previewChat$en {
	...
	@override String get incoming1 => 'Привет! Добро пожаловать в Lingola — я ваш AI-наставник. Готовы попробовать быстрое приветствие на английском?';
...
extension on TranslationsRu {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'setup.levelBeginner' => 'Начальный — я знаю несколько слов',
			'setup.levelIntermediate' => 'Средний — я могу поддерживать простые разговоры',
			'setup.levelAdvanced' => 'Продвинутый — я говорю, но хочу улучшить',
			'setup.paceTitle' => 'Как быстро вы хотите улучшаться?',
			'setup.paceLight' => '5-10 мин/день (легкий)',
			'setup.paceRecommended' => '15-20 мин/день (рекомендуется)',
			'setup.paceFast' => '30+ мин/день (быстрые результаты)',
			...
			'previewChat.incoming1' => 'Привет! Добро пожаловать в Lingola — я ваш AI-наставник. Готовы попробовать быстрое приветствие на английском?',
